...
* **User Input**: Information extracted from user messages can be used to populate variables.
  * [**Capture Block**](../../agents-workflows-and-triggers/blocks/logic-blocks/capture-block.md): Values are extracted from user messages and stored within a variable.
  * [**Prompt Block**](../../agents-workflows-and-triggers/blocks/utility-blocks/prompt-block.md): JSON data returned by a Prompt Block fills the variable with the required values.
* **Manual Configuration**: You can set the value of a variable manually during the workflow configuration process.
  * [**Set Values Block**](../../agents-workflows-and-triggers/blocks/logic-blocks/set-values-block.md): The value of a variable can be manually set during the workflow configuration.
...
Both states allow you to reset or validate variables during the conversation flow, especially when configuring logic with the [Set Values](../../agents-workflows-and-triggers/blocks/logic-blocks/set-values-block.md) or [Condition](../../agents-workflows-and-triggers/blocks/logic-blocks/condition-block.md) blocks.
{% endhint %}
...
{% hint style="danger" %}
You cannot assign values to a Map variable directly from a [Capture block](../../agents-workflows-and-triggers/blocks/logic-blocks/capture-block.md).
{% endhint %}
...
#### Using Map Variables in [Condition Blocks](../../agents-workflows-and-triggers/blocks/logic-blocks/condition-block.md)
