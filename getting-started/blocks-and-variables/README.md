...
2. [**Action blocks**](action-blocks/) allow both users and the virtual assistant to **perform specific actions** within the conversation flow, such as **sending emails, selecting from multiple predefined options, uploading documents, or speaking with a human operator**.
