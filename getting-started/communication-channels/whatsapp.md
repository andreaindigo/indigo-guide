...
* **Customization Limitations**:
  ...
  * The typebar cannot be disabled when using [quick replies](../agents-workflows-and-triggers/blocks/action-blocks/quick-reply-block.md), so users may type their responses instead of clicking the buttons.
