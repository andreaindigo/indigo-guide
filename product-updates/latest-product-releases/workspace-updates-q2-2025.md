...
{% hint style="info" %}
Explore how it works → [collect-block.md](../../getting-started/agents-workflows-and-triggers/blocks/logic-blocks/collect-block.md "mention")
{% endhint %}
...
{% hint style="info" %}
Deep dive on the new Prompt Block → [#message-composer](../../getting-started/agents-workflows-and-triggers/blocks/utility-blocks/prompt-block.md#message-composer "mention")
{% endhint %}
...
{% hint style="info" %}
Learn how to use the new block → [metadata-block.md](../../getting-started/agents-workflows-and-triggers/blocks/utility-blocks/metadata-block.md "mention")
{% endhint %}
