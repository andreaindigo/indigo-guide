...
### 📌 Centralized [Dashboard](../../getting-started/workspace/utilities/issue-tracker.md)
...
* [**Chats Section**](../../getting-started/workspace/chats/#issue-creation): Hover over any message to flag it, triggering a right-side panel where you can add the issue title, description, priority, tag, and assignee.

<figure><img src="../../.gitbook/assets/create issue from chat.png" alt=""><figcaption></figcaption></figure>

* [**Issue Tracker Page**](../../getting-started/workspace/utilities/issue-tracker.md): Click the "+ Create Issue" button to log feedback not tied to a specific interaction.
