...
Use the [**Chat section**](../getting-started/workspace/chats/) in the platform to browse conversation history and take advantage of the [debugging tools](../getting-started/workspace/chats/debugging.md) to trace how each response was generated. You can also apply the structured feedback collection process outlined in our pre-go-live testing guide: [testing-and-debugging.md](testing-and-debugging.md "mention").&#x20;
...
For a detailed explanation of analytics data and metrics, refer to this section of our platform guide: [analytics.md](../getting-started/workspace/analytics.md "mention").&#x20;
